...
var _NgDropdownPanelComponent = class _NgDropdownPanelComponent {
  ...
  constructor() {
    ...
    this.showAddTag = input(false, ...ngDevMode ? [{
    ...
    this.contentElementRef = viewChild("content", ...ngDevMode ? [{
      debugName: "contentElementRef",
      read: ElementRef
    }] : [{
      read: ElementRef
    }]);
    this.scrollElementRef = viewChild("scroll", ...ngDevMode ? [{
      debugName: "scrollElementRef",
      read: ElementRef
    }] : [{
      read: ElementRef
    }]);
    this.paddingElementRef = viewChild("padding", ...ngDevMode ? [{
  ...
  _handleScroll() {
    this._zone.runOutsideAngular(() => {
      ...
      fromEvent(this._scrollablePanel(), "scroll").pipe(takeUntilDestroyed(this._destroyRef), auditTime(0, SCROLL_SCHEDULER)).subscribe((event) => {
...
var _NgSelectComponent = class _NgSelectComponent {
  constructor() {
    ...
    this.markFirst = input(true, ...ngDevMode ? [{
      debugName: "markFirst",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    ...
    this.hideSelected = input(false, ...ngDevMode ? [{
      debugName: "hideSelected",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    }]);
    this.selectOnTab = input(false, ...ngDevMode ? [{
      debugName: "selectOnTab",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    }]);
    this.openOnEnter = input(void 0, ...ngDevMode ? [{
      debugName: "openOnEnter",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    }]);
    this.maxSelectedItems = input(void 0, ...ngDevMode ? [{
    ...
    this.bufferAmount = input(4, ...ngDevMode ? [{
      debugName: "bufferAmount",
      transform: numberAttribute
    }] : [{
      transform: numberAttribute
    }]);
    this.virtualScroll = input(void 0, ...ngDevMode ? [{
      debugName: "virtualScroll",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    }]);
    this.selectableGroup = input(false, ...ngDevMode ? [{
    ...
    this.selectableGroupAsModel = input(true, ...ngDevMode ? [{
    ...
    this.clearOnBackspace = input(true, ...ngDevMode ? [{
    ...
    this.tabIndex = input(void 0, ...ngDevMode ? [{
      debugName: "tabIndex",
      transform: numberAttribute
    }] : [{
      transform: numberAttribute
    ...
    this.searchWhileComposing = input(true, ...ngDevMode ? [{
      debugName: "searchWhileComposing",
      transform: booleanAttribute
    }] : [{
      transform: booleanAttribute
    }]);
    this.minTermLength = input(0, ...ngDevMode ? [{
      debugName: "minTermLength",
      transform: numberAttribute
    }] : [{
      transform: numberAttribute
    }]);
    this.editableSearchTerm = input(false, ...ngDevMode ? [{
    ...
    this.searchable = input(true, ...ngDevMode ? [{
    ...
    this.compareWith = input(void 0, ...ngDevMode ? [{
    ...
    this.optionTemplate = contentChild(NgOptionTemplateDirective, ...ngDevMode ? [{
      debugName: "optionTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.optgroupTemplate = contentChild(NgOptgroupTemplateDirective, ...ngDevMode ? [{
      debugName: "optgroupTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.labelTemplate = contentChild(NgLabelTemplateDirective, ...ngDevMode ? [{
      debugName: "labelTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.multiLabelTemplate = contentChild(NgMultiLabelTemplateDirective, ...ngDevMode ? [{
      debugName: "multiLabelTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.headerTemplate = contentChild(NgHeaderTemplateDirective, ...ngDevMode ? [{
      debugName: "headerTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.footerTemplate = contentChild(NgFooterTemplateDirective, ...ngDevMode ? [{
      debugName: "footerTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.notFoundTemplate = contentChild(NgNotFoundTemplateDirective, ...ngDevMode ? [{
      debugName: "notFoundTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.placeholderTemplate = contentChild(NgPlaceholderTemplateDirective, ...ngDevMode ? [{
      debugName: "placeholderTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.typeToSearchTemplate = contentChild(NgTypeToSearchTemplateDirective, ...ngDevMode ? [{
      debugName: "typeToSearchTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.loadingTextTemplate = contentChild(NgLoadingTextTemplateDirective, ...ngDevMode ? [{
      debugName: "loadingTextTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.tagTemplate = contentChild(NgTagTemplateDirective, ...ngDevMode ? [{
      debugName: "tagTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.loadingSpinnerTemplate = contentChild(NgLoadingSpinnerTemplateDirective, ...ngDevMode ? [{
      debugName: "loadingSpinnerTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.clearButtonTemplate = contentChild(NgClearButtonTemplateDirective, ...ngDevMode ? [{
      debugName: "clearButtonTemplate",
      read: TemplateRef
    }] : [{
      read: TemplateRef
    }]);
    this.ngOptions = contentChildren(NgOptionComponent, ...ngDevMode ? [{
      debugName: "ngOptions",
      descendants: true
    }] : [{
      descendants: true
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7X4BWHV7.js.map
