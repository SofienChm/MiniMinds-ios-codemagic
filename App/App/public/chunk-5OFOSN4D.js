...
var FullCalendarComponent = class {
  ...
  */
  ...
  // for `trackBy` in loop
  trackCustomRendering(index4, customRendering) {
...
var _c02 = (a0) => ({ "isholiday": a0 });
var _c18 = (a0) => ({ label: a0, url: "/dashboard" });
var _c22 = (a0) => ({ label: a0 });
var _c32 = (a0, a1) => [a0, a1];
function CalendarPageComponent_ion_content_0_div_13_div_1_small_15_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r3.place, " ");
  }
}
function CalendarPageComponent_ion_content_0_div_13_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 37)(11, "div", 38)(12, "h6", 39);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 40);
    \u0275\u0275template(15, CalendarPageComponent_ion_content_0_div_13_div_1_small_15_Template, 3, 1, "small", 41);
    \u0275\u0275elementStart(16, "div")(17, "small", 42)(18, "span", 43);
    \u0275\u0275element(19, "i", 44);
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(24, _c02, ctx_r1.isHoliday(item_r3)));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(6, 7, ctx_r1.getItemDateTime(item_r3), "d", "", ctx_r1.currentLocale));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(9, 12, ctx_r1.getItemDateTime(item_r3), "MMM", "", ctx_r1.currentLocale));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", item_r3.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.isEvent(item_r3) && item_r3.place);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isEvent(item_r3) ? item_r3.type : \u0275\u0275pipeBind1(21, 17, "CALENDAR_PAGE.HOLIDAY"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(25, 19, ctx_r1.getItemDateTime(item_r3), "shortTime", "", ctx_r1.currentLocale));
  }
}
function CalendarPageComponent_ion_content_0_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275template(1, CalendarPageComponent_ion_content_0_div_13_div_1_Template, 26, 26, "div", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.getUpcomingEvents());
  }
}
function CalendarPageComponent_ion_content_0_div_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 1, "CALENDAR_PAGE.NO_UPCOMING_EVENTS"));
  }
}
function CalendarPageComponent_ion_content_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-content", 19)(1, "ion-refresher", 20);
    \u0275\u0275listener("ionRefresh", function CalendarPageComponent_ion_content_0_Template_ion_refresher_ionRefresh_1_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275element(4, "app-parent-child-header-simple", 22);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementStart(6, "div", 23)(7, "div", 24);
    \u0275\u0275element(8, "full-calendar", 25);
    \u0275\u0275elementStart(9, "div", 24)(10, "h5", 26);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, CalendarPageComponent_ion_content_0_div_13_Template, 2, 1, "div", 27)(14, CalendarPageComponent_ion_content_0_div_14_Template, 7, 3, "div", 28);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("title", \u0275\u0275pipeBind1(5, 5, "CALENDAR_PAGE.CALENDAR"));
    \u0275\u0275advance(4);
    \u0275\u0275property("options", ctx_r1.calendarOptions);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 7, "CALENDAR_PAGE.UPCOMING_EVENTS_HOLIDAYS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.getUpcomingEvents().length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.getUpcomingEvents().length == 0);
  }
}
function CalendarPageComponent_div_1_div_25_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "strong", 68);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "br");
    \u0275\u0275elementStart(4, "small", 69);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(event_r4.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", event_r4.type, " - ", \u0275\u0275pipeBind4(6, 3, event_r4.time, "shortTime", "", ctx_r1.currentLocale));
  }
}
function CalendarPageComponent_div_1_div_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, CalendarPageComponent_div_1_div_25_div_1_Template, 7, 8, "div", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CalendarPageComponent_div_1_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "CALENDAR_PAGE.NO_EVENTS_SCHEDULED"));
  }
}
function CalendarPageComponent_div_1_div_35_div_1_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarPageComponent_div_1_div_35_div_1_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind1(2, 2, "CALENDAR_PAGE.AT"), " ", \u0275\u0275pipeBind4(3, 4, ctx_r1.getItemDateTime(item_r5), "shortTime", "", ctx_r1.currentLocale));
  }
}
function CalendarPageComponent_div_1_div_35_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 72)(1, "strong", 73);
    \u0275\u0275template(2, CalendarPageComponent_div_1_div_35_div_1_span_2_Template, 2, 0, "span", 74);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "small", 75);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "date");
    \u0275\u0275template(7, CalendarPageComponent_div_1_div_35_div_1_span_7_Template, 4, 9, "span", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "small", 76);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("ngClass", ctx_r1.isHoliday(item_r5) ? "border-danger bg-danger bg-opacity-10" : "border-primary");
    \u0275\u0275advance();
    \u0275\u0275classProp("text-danger", ctx_r1.isHoliday(item_r5));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isHoliday(item_r5));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", item_r5.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(6, 8, ctx_r1.getItemDateTime(item_r5), "MMM d, y", "", ctx_r1.currentLocale), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.isEvent(item_r5));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.isEvent(item_r5) ? item_r5.type : \u0275\u0275pipeBind1(10, 13, "CALENDAR_PAGE.HOLIDAY"));
  }
}
function CalendarPageComponent_div_1_div_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, CalendarPageComponent_div_1_div_35_div_1_Template, 11, 15, "div", 71);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CalendarPageComponent_div_1_ng_template_36_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "CALENDAR_PAGE.NO_UPCOMING_EVENTS_SHORT"));
  }
}
function CalendarPageComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "app-title-page", 52);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementStart(5, "div", 53)(6, "div", 54)(7, "div", 55)(8, "div", 56)(9, "div", 57);
    \u0275\u0275element(10, "full-calendar", 25);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 58)(12, "div", 59)(13, "div", 60);
    \u0275\u0275element(14, "i", 61);
    \u0275\u0275elementStart(15, "h5", 51);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 57)(19, "p", 62)(20, "strong");
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275text(23);
    \u0275\u0275pipe(24, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(25, CalendarPageComponent_div_1_div_25_Template, 2, 1, "div", 63)(26, CalendarPageComponent_div_1_ng_template_26_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 64)(29, "div", 60);
    \u0275\u0275element(30, "i", 65);
    \u0275\u0275elementStart(31, "h5", 51);
    \u0275\u0275text(32);
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 57);
    \u0275\u0275template(35, CalendarPageComponent_div_1_div_35_Template, 2, 1, "div", 63)(36, CalendarPageComponent_div_1_ng_template_36_Template, 3, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const noEvents_r6 = \u0275\u0275reference(27);
    const noUpcoming_r7 = \u0275\u0275reference(37);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMap(ctx_r1.isParent ? "" : "container-fluid mt-4");
    \u0275\u0275advance();
    \u0275\u0275property("title", \u0275\u0275pipeBind1(2, 13, "CALENDAR_PAGE.CALENDAR"))("breadcrumbs", \u0275\u0275pureFunction2(34, _c32, \u0275\u0275pureFunction1(30, _c18, \u0275\u0275pipeBind1(3, 15, "CALENDAR_PAGE.DASHBOARD")), \u0275\u0275pureFunction1(32, _c22, \u0275\u0275pipeBind1(4, 17, "CALENDAR_PAGE.CALENDAR"))));
    \u0275\u0275advance(9);
    \u0275\u0275property("options", ctx_r1.calendarOptions);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 19, "CALENDAR_PAGE.SELECTED_DATES"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 21, "CALENDAR_PAGE.DATE"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(24, 23, ctx_r1.selectedDate, "fullDate", "", ctx_r1.currentLocale));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.getEventsForDate(ctx_r1.selectedDate).length > 0)("ngIfElse", noEvents_r6);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 28, "CALENDAR_PAGE.UPCOMING_EVENTS_HOLIDAYS"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.getUpcomingEvents().length > 0)("ngIfElse", noUpcoming_r7);
  }
}
function CalendarPageComponent_div_4_p_23_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 2, "CALENDAR_PAGE.DESCRIPTION"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedEvent.description);
  }
}
function CalendarPageComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CalendarPageComponent_div_4_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeEventModal());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 12)(6, "p")(7, "strong");
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275text(10);
    ...
    \u0275\u0275pipe(22, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(23, CalendarPageComponent_div_4_p_23_Template, 5, 4, "p", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 15)(25, "button", 16);
    \u0275\u0275listener("click", function CalendarPageComponent_div_4_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeEventModal());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.selectedEvent.name);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 9, "CALENDAR_PAGE.TYPE"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedEvent.type);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 11, "CALENDAR_PAGE.DATE"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(16, 13, ctx_r1.selectedEvent.time, "fullDate", "", ctx_r1.currentLocale));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 18, "CALENDAR_PAGE.TIME"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(22, 20, ctx_r1.selectedEvent.time, "shortTime", "", ctx_r1.currentLocale));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.selectedEvent.description);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 25, "CALENDAR_PAGE.CLOSE"));
  }
}
function CalendarPageComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275listener("click", function CalendarPageComponent_div_5_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeEventModal());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("show", ctx_r1.selectedEvent);
  }
}
function CalendarPageComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 79)(1, "h6", 80);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 51)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const holiday_r10 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u{1F389} ", holiday_r10.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 2, "CALENDAR_PAGE.HOLIDAY"));
  }
}
function CalendarPageComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 81);
    \u0275\u0275listener("click", function CalendarPageComponent_div_17_Template_div_click_0_listener() {
      const event_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.selectedEvent = event_r12;
      return \u0275\u0275resetView(ctx_r1.showDateEventsModal = false);
    });
    \u0275\u0275elementStart(1, "h6", 82);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 83)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 51)(9, "strong");
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 5, "CALENDAR_PAGE.TYPE"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", event_r12.type);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 7, "CALENDAR_PAGE.TIME"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(13, 9, event_r12.time, "shortTime", "", ctx_r1.currentLocale));
  }
}
function CalendarPageComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275listener("click", function CalendarPageComponent_div_22_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeDateEventsModal());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("show", ctx_r1.showDateEventsModal);
  }
}
function CalendarPageComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275listener("click", function CalendarPageComponent_div_41_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeNoEventsModal());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("show", ctx_r1.showNoEventsModal);
  }
}
...
var CalendarPageComponent = class _CalendarPageComponent {
  ...
  calendarOptions = {
    ...
    dayCellClassNames: (arg) => {
      ...
      const classes = [];
      const hasHoliday = this.holidays.some((h3) => {
        const holidayDate = new Date(h3.date);
        holidayDate.setHours(0, 0, 0, 0);
        return cellDate.getTime() === holidayDate.getTime();
      });
      const hasEvent = this.events.some((e3) => {
        const eventDate = new Date(e3.time);
    ...
    eventClick: (info) => {
      this.selectedEvent = this.events.find((e3) => e3.id === parseInt(info.event.id)) || null;
    }
  };
  get isParent() {
  ...
  constructor(authService, eventService, holidayService, router, translateService, pageTitleService) {
  ...
  setCalendarLocale(lang) {
    ...
    this.calendarOptions = __spreadProps(__spreadValues({}, this.calendarOptions), {
  ...
  updateCalendarEvents() {
    const eventItems = this.events.map((e3) => ({
      id: "event-" + e3.id?.toString(),
      title: e3.name,
      start: e3.time,
      backgroundColor: e3.type === "Holiday" ? "#dc3545" : "#0d6efd"
    }));
    const holidayItems = this.holidays.map((h3) => ({
      id: "holiday-" + h3.id?.toString(),
      title: h3.name,
      start: h3.date,
  ...
  getUpcomingEvents() {
    ...
    const upcomingEvents = this.events.filter((event) => new Date(event.time) > now).map((event) => __spreadProps(__spreadValues({}, event), { itemType: "event", dateTime: event.time }));
    const upcomingHolidays = this.holidays.filter((holiday) => new Date(holiday.date) > now).map((holiday) => __spreadProps(__spreadValues({}, holiday), { itemType: "holiday", dateTime: holiday.date }));
    return [...upcomingEvents, ...upcomingHolidays].sort((a3, b3) => new Date(a3.dateTime).getTime() - new Date(b3.dateTime).getTime()).slice(0, 5);
  }
  isEvent(item) {
  ...
  static \u0275fac = function CalendarPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CalendarPageComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(EventService), \u0275\u0275directiveInject(HolidayService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(PageTitleService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CalendarPageComponent, selectors: [["app-calendar-page"]], decls: 42, vars: 47, consts: [["noEvents", ""], ["noUpcoming", ""], ["class", "parent-calendar", 4, "ngIf"], [3, "class", 4, "ngIf"], ["tabindex", "-1", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered"], ["class", "modal-content", 4, "ngIf"], ["class", "modal-backdrop fade", 3, "show", "click", 4, "ngIf"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], ["type", "button", 1, "btn-close", 3, "click"], [1, "modal-body"], ["class", "mb-3 p-3 border rounded bg-danger bg-opacity-10", 4, "ngFor", "ngForOf"], ["class", "mb-3 p-3 border rounded", "style", "cursor: pointer;", 3, "click", 4, "ngFor", "ngForOf"], [1, "modal-footer"], ["type", "button", 1, "custom-btn-2", "btn-cancel-2", 3, "click"], [1, "modal-body", "text-center"], [1, "bi", "bi-calendar-x", "icon-3x", "mb-3", "opacity-25"], [1, "parent-calendar"], ["slot", "fixed", 3, "ionRefresh"], [1, "parent-detailchild", "font-inter"], [3, "title"], [1, "body", "container-fluid"], [1, "main-information"], [3, "options"], [1, "title-body"], ["class", "profile-info-grid", 4, "ngIf"], ["class", "card card-general shadow-sm", 4, "ngIf"], [1, "profile-info-grid"], ["class", "event-item mb-3", "style", "cursor: pointer;", 4, "ngFor", "ngForOf"], [1, "event-item", "mb-3", 2, "cursor", "pointer"], [1, "d-flex", "align-items-center", "p-3", "bg-light", "rounded", "event-card"], [1, "event-icon", "me-2", 3, "ngClass"], [1, "icon-circle", "d-flex", "flex-column", "align-items-center", "justify-content-center"], [1, "day"], [1, "month"], [1, "event-content", "flex-grow-1"], [1, "d-flex", "justify-content-between", "align-items-start"], [1, "event-name", "mb-0"], [1, "event-details"], ["class", "text-muted clplace", 4, "ngIf"], [1, "text-muted", "date-type"], [1, "me-2"], [1, "bi", "bi-calendar2-event"], [1, "bi", "bi-clock-history"], [1, "text-muted", "clplace"], [1, "bi", "bi-geo-alt"], [1, "card", "card-general", "shadow-sm"], [1, "text-center"], [1, "card-body", "text-center", "text-muted", "py-4"], [1, "mb-0"], [3, "title", "breadcrumbs"], [1, "container-fluid"], [1, "row"], [1, "col-lg-8", "calender-mobile"], [1, "card", "card-general"], [1, "card-body"], [1, "col-lg-4", "selectdate-mobile"], [1, "card", "card-general", "shadow-sm", "selected-day"], [1, "card-header"], [1, "bi", "bi-check2-circle"], [1, "mb-1", "selected-event_day"], [4, "ngIf", "ngIfElse"], [1, "card", "card-general", "shadow-sm", "mt-3", "card-upcoming_calendar"], [1, "bi", "bi-clock"], ["class", "mb-2 p-2 bg-light rounded", 4, "ngFor", "ngForOf"], [1, "mb-2", "p-2", "bg-light", "rounded"], [1, "selected-event_day"], [1, "selected-event_time"], [1, "mb-0", "selected-event_time"], ["class", "mb-3 p-2 border-start border-3", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "mb-3", "p-2", "border-start", "border-3", 3, "ngClass"], [1, "d-block", "name"], [4, "ngIf"], [1, "text-muted", "d-block", "time"], [1, "text-muted", "type"], [1, "mb-0", "text-muted"], [1, "modal-backdrop", "fade", 3, "click"], [1, "mb-3", "p-3", "border", "rounded", "bg-danger", "bg-opacity-10"], [1, "mb-2", "text-danger"], [1, "mb-3", "p-3", "border", "rounded", 2, "cursor", "pointer", 3, "click"], [1, "mb-2"], [1, "mb-1"]], template: function CalendarPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, CalendarPageComponent_ion_content_0_Template, 15, 9, "ion-content", 2)(1, CalendarPageComponent_div_1_Template, 38, 37, "div", 3);
      \u0275\u0275elementStart(2, "div", 4)(3, "div", 5);
      \u0275\u0275template(4, CalendarPageComponent_div_4_Template, 28, 27, "div", 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(5, CalendarPageComponent_div_5_Template, 1, 2, "div", 7);
      \u0275\u0275elementStart(6, "div", 4)(7, "div", 5)(8, "div", 8)(9, "div", 9)(10, "h5", 10);
      \u0275\u0275text(11);
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275pipe(13, "date");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_14_listener() {
        return ctx.closeDateEventsModal();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 12);
      \u0275\u0275template(16, CalendarPageComponent_div_16_Template, 7, 4, "div", 13)(17, CalendarPageComponent_div_17_Template, 14, 14, "div", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 15)(19, "button", 16);
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_19_listener() {
        return ctx.closeDateEventsModal();
      });
      \u0275\u0275text(20);
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(22, CalendarPageComponent_div_22_Template, 1, 2, "div", 7);
      \u0275\u0275elementStart(23, "div", 4)(24, "div", 5)(25, "div", 8)(26, "div", 9)(27, "h5", 10);
      \u0275\u0275text(28);
      \u0275\u0275pipe(29, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "button", 11);
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_30_listener() {
        return ctx.closeNoEventsModal();
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_38_listener() {
        return ctx.closeNoEventsModal();
      });
      \u0275\u0275text(39);
      \u0275\u0275pipe(40, "translate");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(41, CalendarPageComponent_div_41_Template, 1, 2, "div", 7);
    }
    if (rf & 2) {
      \u0275\u0275property("ngIf", ctx.isParent && !ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.isParent);
      \u0275\u0275advance();
      \u0275\u0275styleProp("display", ctx.selectedEvent ? "block" : "none");
      \u0275\u0275classProp("show", ctx.selectedEvent);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.selectedEvent);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.selectedEvent);
      \u0275\u0275advance();
      \u0275\u0275styleProp("display", ctx.showDateEventsModal ? "block" : "none");
      \u0275\u0275classProp("show", ctx.showDateEventsModal);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind1(12, 27, "CALENDAR_PAGE.EVENTS_ON"), " ", \u0275\u0275pipeBind4(13, 29, ctx.selectedDate, "fullDate", "", ctx.currentLocale));
      \u0275\u0275advance(5);
      \u0275\u0275property("ngForOf", ctx.selectedDateHolidays);
      \u0275\u0275advance();
      \u0275\u0275property("ngForOf", ctx.selectedDateEvents);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 34, "CALENDAR_PAGE.CLOSE"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.showDateEventsModal);
      \u0275\u0275advance();
      \u0275\u0275styleProp("display", ctx.showNoEventsModal ? "block" : "none");
      \u0275\u0275classProp("show", ctx.showNoEventsModal);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(29, 36, "CALENDAR_PAGE.NO_EVENTS"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind1(35, 38, "CALENDAR_PAGE.NO_EVENT_ON_DATE"), " ", \u0275\u0275pipeBind4(36, 40, ctx.selectedDate, "fullDate", "", ctx.currentLocale));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(40, 45, "CALENDAR_PAGE.CLOSE"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.showNoEventsModal);
    }
  }, dependencies: [CommonModule, NgClass, NgForOf, NgIf, TitlePage, FullCalendarModule, FullCalendarComponent, ParentChildHeaderSimpleComponent, TranslateModule, IonContent, IonRefresher, IonRefresherContent, DatePipe, TranslatePipe], styles: ['\n\nion-content.parent-calendar[_ngcontent-%COMP%] {\n  --background: #ffffff;\n  --padding-start: 0;\n  --padding-end: 0;\n  --padding-top: 0;\n  --padding-bottom: 0;\n  display: block !important;\n  position: relative !important;\n  min-height: calc(100vh - 95px) !important;\n}\nion-content.parent-calendar[_ngcontent-%COMP%]   .inner-scroll[_ngcontent-%COMP%] {\n  display: block !important;\n}\n  .header-info {\n  margin-bottom: 35px !important;\n}\n  .profile-info-grid {\n  display: block !important;\n}\n  .profile-info-grid .profile-info-card {\n  margin-bottom: 20px;\n}\n  .profile-info-grid .profile-info-card .info-title {\n  font-size: 15px !important;\n  font-weight: 500 !important;\n  color: #202C4B !important;\n}\n  .profile-info-grid .profile-info-card .info-desc {\n  font-size: 12px !important;\n  font-weight: 400 !important;\n}\n  .fc-theme-standard {\n  box-shadow: none !important;\n  border-radius: 0 !important;\n}\n.main-information[_ngcontent-%COMP%] {\n  margin-top: 35px;\n}\n.main-information[_ngcontent-%COMP%]   .fc-theme-standard[_ngcontent-%COMP%] {\n  padding: 15px !important;\n  border-radius: 16px !important;\n}\n.selected-day[_ngcontent-%COMP%]   .card-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  border-bottom: 2px solid #f0f0f0;\n}\n.selected-day[_ngcontent-%COMP%]   .card-header[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 24px;\n  color: #7dd3c0;\n  margin-right: 12px;\n}\n  .fc-header-toolbar .fc-button {\n  background:\n    linear-gradient(\n      135deg,\n      #a8c5ff 0%,\n      #7dd3c0 100%);\n  border: none;\n  color: white;\n}\n  .fc-header-toolbar .fc-button:hover {\n  background: #7dd3c0;\n  color: white;\n}\n  .fc-header-toolbar .fc-button:not(:disabled):active, \n  .fc-header-toolbar .fc-button:active {\n  background: #7dd3c0;\n  color: white;\n}\n  .fc-header-toolbar .fc-button:focus {\n  box-shadow: rgba(129, 210, 198, 0.5) 0px 0px 0px 0.2rem;\n}\n  .fc {\n  font-size: 14px;\n}\n  .fc-toolbar-title {\n  font-size: 18px !important;\n  font-weight: 500 !important;\n  color: #202C4B !important;\n}\n  .fc-scrollgrid {\n  border: 1px solid #ddd;\n  width: 100%;\n}\n  .fc-col-header-cell {\n  background: #f8f9fa;\n  padding: 10px;\n  text-align: center;\n  font-weight: 600;\n  border: 1px solid #ddd;\n}\n  .fc-col-header-cell.fc-day {\n  background: #fff;\n  border: none;\n  text-align: center;\n  padding: 8px 0;\n}\n  .fc-col-header-cell.fc-day a {\n  color: #202C4B !important;\n  font-size: 14px;\n  font-weight: 700;\n  text-decoration: none;\n}\n  .fc-daygrid-day {\n  border: 1px solid #ddd;\n  min-height: 100px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n  background: #fff;\n}\n  .fc-daygrid-day:hover {\n  background-color: #f8f9fa;\n}\n  .fc-daygrid-day-frame {\n  padding: 5px;\n  min-height: 100px;\n}\n  .fc-daygrid-day-top {\n  display: flex;\n  justify-content: flex-end;\n}\n  .fc-daygrid-day-number {\n  padding: 4px 8px;\n  text-decoration: none;\n  color: #333;\n  font-weight: 500;\n}\n  .fc-day-today {\n  background-color: transparent !important;\n}\n  .fc-day-today .fc-daygrid-day-number {\n  background: #a8c5ff;\n  color: white;\n  border-radius: 50%;\n  width: 30px;\n  height: 30px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n  .fc-day.holiday .fc-daygrid-day-number {\n  color: #dc3560;\n  font-weight: 700;\n}\n  .fc-day.holiday .fc-daygrid-event.fc-event-end {\n  padding: 9px 6px;\n}\n  .fc-day.holiday .fc-daygrid-event-dot {\n  border-color: #dc3560 !important;\n}\n  .fc-day.holiday .fc-daygrid-event-harness {\n  background-color: #fbeaec;\n  border-radius: 5px;\n}\n  .fc-day.holiday .fc-event-title {\n  color: #dc3560 !important;\n}\n  .event-day .fc-daygrid-event.fc-event-end {\n  padding: 9px 6px;\n}\n  .event-day .fc-daygrid-event-dot {\n  border-color: #7dd3c0 !important;\n}\n  .event-day .fc-daygrid-event-harness {\n  border-color: #7dd3c0 !important;\n  background-color: #effcf9;\n  border-radius: 5px;\n}\n  .event-day .fc-event-title {\n  color: #7dd3c0 !important;\n}\n  .fc-day.event-day .fc-daygrid-day-number {\n  color: #7dd3c0 !important;\n  font-weight: 700;\n}\n  .fc-daygrid-event-harness {\n  margin: 2px 0;\n}\n@media screen and (max-width: 768px) {\n    .fc-daygrid-event-dot {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n    .fc-event-title {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n    .fc-daygrid-event {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n    .fc-daygrid-day-events {\n    display: none;\n  }\n}\n@media screen and (max-width: 767px) {\n    .fc-daygrid-day:has(.fc-daygrid-event-harness) .fc-daygrid-day-number {\n    border-radius: 50%;\n    width: 30px;\n    height: 30px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n    .fc-day-today .fc-daygrid-day-number {\n    background: #7dd3c0;\n  }\n}\n  .fc-event {\n  display: block;\n  padding: 2px 4px;\n  border-radius: 3px;\n  font-size: 12px;\n  cursor: pointer;\n  border: none;\n  text-decoration: none;\n  color: rgb(7, 7, 7);\n}\n  .fc-daygrid-dot-event {\n  padding-left: 4px;\n}\n  .fc-event:hover {\n  opacity: 0.8;\n}\n  .fc-event-main {\n  color: white;\n}\n  .fc-event-title {\n  font-weight: 500;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n  .fc-event-time {\n  font-size: 11px;\n  opacity: 0.9;\n}\n  .fc-daygrid-day-events {\n  margin-top: 5px;\n}\n  .fc-scroller {\n  overflow: visible !important;\n}\n  table.fc-scrollgrid-sync-table {\n  width: 100%;\n  border-collapse: collapse;\n}\n.card-upcoming_calendar[_ngcontent-%COMP%]   .card-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  border-bottom: 2px solid #f0f0f0;\n}\n.card-upcoming_calendar[_ngcontent-%COMP%]   .card-header[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 24px;\n  color: #7dd3c0;\n  margin-right: 12px;\n}\n.card-upcoming_calendar[_ngcontent-%COMP%]   .name[_ngcontent-%COMP%] {\n  font-size: 15px;\n  font-weight: 500;\n  color: #7dd3c0;\n}\n.card-upcoming_calendar[_ngcontent-%COMP%]   .time[_ngcontent-%COMP%] {\n  font-size: 12px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.card-upcoming_calendar[_ngcontent-%COMP%]   .type[_ngcontent-%COMP%] {\n  font-size: 12px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.selected-event_day[_ngcontent-%COMP%] {\n  font-size: 15px;\n  font-weight: 500;\n  color: #202C4B;\n}\n.selected-event_time[_ngcontent-%COMP%] {\n  font-size: 13px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.border-primary[_ngcontent-%COMP%] {\n  border-color: #7dd3c0 !important;\n  background-color: #effcf9;\n}\n  .fc .fc-toolbar.fc-header-toolbar {\n  margin-bottom: 9px !important;\n}\n  .fc-theme-standard {\n  background: white;\n  border-radius: 20px;\n  padding: 0px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n}\n@media screen and (max-width: 768px) {\n    .fc-theme-standard td, \n     .fc-theme-standard th {\n    border: none !important;\n  }\n    .fc-scrollgrid {\n    border: none !important;\n  }\n    .fc-daygrid-day:has(.fc-daygrid-event-harness) .fc-daygrid-day-number:before {\n    content: "";\n    width: 7px;\n    height: 7px;\n    background: var(--secondary-color);\n    bottom: -2px;\n    border-radius: 50px;\n    position: absolute;\n  }\n    .fc-day.holiday .fc-daygrid-day-number:before {\n    background: #dc3560 !important;\n  }\n    .fc-day.event-day .fc-daygrid-day-number {\n    color: var(--secondary-color) !important;\n  }\n    .event-icon {\n    background: var(--secondary-color);\n    padding: 10px;\n    border-radius: 8px;\n  }\n    .event-icon .day {\n    font-weight: bold;\n    color: white;\n  }\n    .event-icon .month {\n    font-size: 14px;\n    font-weight: 400;\n    color: white;\n  }\n    .clplace {\n    font-size: 13px;\n  }\n    .date-type span {\n    font-size: 12px;\n  }\n    .calender-mobile {\n    padding: 0px;\n  }\n    .selectdate-mobile {\n    padding: 0px;\n  }\n}\n.event-item[_ngcontent-%COMP%]   .event-card[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 14px;\n  padding: 16px;\n  display: flex;\n  align-items: center;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n  margin-bottom: 12px;\n  transition: transform 0.2s;\n}\n/*# sourceMappingURL=calendar.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CalendarPageComponent, [{
    type: Component,
    args: [{ selector: "app-calendar-page", imports: [CommonModule, TitlePage, FullCalendarModule, ParentChildHeaderSimpleComponent, TranslateModule, IonContent, IonRefresher, IonRefresherContent], template: `<ion-content *ngIf="isParent && !loading" class="parent-calendar">\r
...
\r
  <div class="parent-detailchild font-inter">\r
    <app-parent-child-header-simple\r
      [title]="'CALENDAR_PAGE.CALENDAR' | translate"\r
    >\r
    </app-parent-child-header-simple>\r
    <div class="body container-fluid">\r
          <div class="main-information">\r
            <full-calendar [options]="calendarOptions"></full-calendar>\r
            <div class="main-information">\r
              <h5 class="title-body">\r
                {{ 'CALENDAR_PAGE.UPCOMING_EVENTS_HOLIDAYS' | translate }}\r
              </h5>\r
                \r
              <div class="profile-info-grid" *ngIf="getUpcomingEvents().length > 0">\r
                <div *ngFor="let item of getUpcomingEvents()" class="event-item mb-3"  style="cursor: pointer;">\r
                  <div class="d-flex align-items-center p-3 bg-light rounded event-card">\r
                    <div [ngClass]="{'isholiday': isHoliday(item)}" class="event-icon me-2">\r
                      <div class="icon-circle d-flex flex-column align-items-center justify-content-center">\r
                        <div class="day">{{ getItemDateTime(item) | date:'d':'':currentLocale }}</div>\r
                        <div class="month">{{ getItemDateTime(item) | date:'MMM':'':currentLocale }}</div>\r
                      </div>\r
                    </div>\r
                    <div class="event-content flex-grow-1">\r
                      <div class="d-flex justify-content-between align-items-start">\r
                        <h6 class="event-name mb-0"> {{ item.name }} </h6>\r
                      </div>\r
                      <div class="event-details">\r
                        <small class="text-muted clplace" *ngIf="isEvent(item) && item.place">\r
                          <i class="bi bi-geo-alt"></i> {{ item.place }}\r
                        </small>\r
                        <div>\r
\r
                        <small class="text-muted date-type">\r
                          <span class="me-2" ><i class="bi bi-calendar2-event"></i> {{ isEvent(item) ? item.type : ('CALENDAR_PAGE.HOLIDAY' | translate) }} </span>\r
                          <span><i class="bi bi-clock-history"></i> {{ getItemDateTime(item) | date:'shortTime':'':currentLocale }}</span>\r
                        </small>\r
                        </div>\r
                      </div>\r
                    </div>\r
              ...
              <div class="card card-general shadow-sm" *ngIf="getUpcomingEvents().length == 0">\r
                <div class="text-center">\r
                  <div class="card-body text-center text-muted py-4">\r
                    <i class="bi bi-calendar-x icon-3x mb-3 opacity-25"></i>\r
                    <p class="mb-0">{{ 'CALENDAR_PAGE.NO_UPCOMING_EVENTS' | translate }}</p>\r
                  </div>\r
                </div>\r
              </div>\r
            </div>\r
...
<div *ngIf="!isParent"  [class]="isParent ? '' : 'container-fluid mt-4'">\r
  <app-title-page\r
  [title]="'CALENDAR_PAGE.CALENDAR' | translate"\r
  [breadcrumbs]="[{label: ('CALENDAR_PAGE.DASHBOARD' | translate), url: '/dashboard'}, {label: ('CALENDAR_PAGE.CALENDAR' | translate)}]">\r
  </app-title-page>\r
  <div class="container-fluid">\r
  <div class="row">\r
    <div class="col-lg-8 calender-mobile">\r
...
\r
    <div class="col-lg-4 selectdate-mobile">\r
      <div class="card card-general shadow-sm selected-day">\r
        <div class="card-header">\r
          <i class="bi bi-check2-circle"></i>\r
          <h5 class="mb-0">{{ 'CALENDAR_PAGE.SELECTED_DATES' | translate }}</h5>\r
        </div>\r
        <div class="card-body">\r
          <p class="mb-1 selected-event_day"><strong>{{ 'CALENDAR_PAGE.DATE' | translate }}</strong> {{ selectedDate | date:'fullDate':'':currentLocale }}</p>\r
          <div *ngIf="getEventsForDate(selectedDate).length > 0; else noEvents">\r
            <div *ngFor="let event of getEventsForDate(selectedDate)" class="mb-2 p-2 bg-light rounded">\r
              <strong class="selected-event_day">{{ event.name }}</strong><br>\r
              <small class="selected-event_time">{{ event.type }} - {{ event.time | date:'shortTime':'':currentLocale }}</small>\r
            </div>\r
          </div>\r
          <ng-template #noEvents>\r
            <p class="mb-0 selected-event_time">{{ 'CALENDAR_PAGE.NO_EVENTS_SCHEDULED' | translate }}</p>\r
          </ng-template>\r
        </div>\r
      </div>\r
\r
      <div class="card card-general shadow-sm mt-3 card-upcoming_calendar">\r
        <div class="card-header">\r
          <i class="bi bi-clock"></i>\r
          <h5 class="mb-0">{{ 'CALENDAR_PAGE.UPCOMING_EVENTS_HOLIDAYS' | translate }}</h5>\r
        </div>\r
        <div class="card-body">\r
          <div *ngIf="getUpcomingEvents().length > 0; else noUpcoming">\r
            <div *ngFor="let item of getUpcomingEvents()"\r
                 class="mb-3 p-2 border-start border-3"\r
                 [ngClass]="isHoliday(item) ? 'border-danger bg-danger bg-opacity-10' : 'border-primary'">\r
              <strong class="d-block name" [class.text-danger]="isHoliday(item)">\r
                <span *ngIf="isHoliday(item)">\u{1F389} </span>{{ item.name }}\r
              </strong>\r
              <small class="text-muted d-block time">\r
                {{ getItemDateTime(item) | date:'MMM d, y':'':currentLocale }}\r
                <span *ngIf="isEvent(item)"> {{ 'CALENDAR_PAGE.AT' | translate }} {{ getItemDateTime(item) | date:'shortTime':'':currentLocale }}</span>\r
              </small>\r
              <small class="text-muted type">{{ isEvent(item) ? item.type : ('CALENDAR_PAGE.HOLIDAY' | translate) }}</small>\r
            </div>\r
          </div>\r
          <ng-template #noUpcoming>\r
            <p class="mb-0 text-muted">{{ 'CALENDAR_PAGE.NO_UPCOMING_EVENTS_SHORT' | translate }}</p>\r
          </ng-template>\r
        </div>\r
      </div>\r
    </div>\r
...
<div class="modal fade" [class.show]="selectedEvent" [style.display]="selectedEvent ? 'block' : 'none'" tabindex="-1">\r
  <div class="modal-dialog modal-dialog-centered">\r
    <div class="modal-content" *ngIf="selectedEvent">\r
      <div class="modal-header">\r
        <h5 class="modal-title">{{ selectedEvent.name }}</h5>\r
        <button type="button" class="btn-close" (click)="closeEventModal()"></button>\r
      </div>\r
      <div class="modal-body">\r
        <p><strong>{{ 'CALENDAR_PAGE.TYPE' | translate }}</strong> {{ selectedEvent.type }}</p>\r
        <p><strong>{{ 'CALENDAR_PAGE.DATE' | translate }}</strong> {{ selectedEvent.time | date:'fullDate':'':currentLocale }}</p>\r
        <p><strong>{{ 'CALENDAR_PAGE.TIME' | translate }}</strong> {{ selectedEvent.time | date:'shortTime':'':currentLocale }}</p>\r
        <p *ngIf="selectedEvent.description"><strong>{{ 'CALENDAR_PAGE.DESCRIPTION' | translate }}</strong> {{ selectedEvent.description }}</p>\r
      </div>\r
      <div class="modal-footer">\r
        <button type="button" class="custom-btn-2 btn-cancel-2" (click)="closeEventModal()">{{ 'CALENDAR_PAGE.CLOSE' | translate }}</button>\r
      </div>\r
    </div>\r
  </div>\r
</div>\r
<div class="modal-backdrop fade" [class.show]="selectedEvent" *ngIf="selectedEvent" (click)="closeEventModal()"></div>\r
\r
<!-- Date Events Modal -->\r
<div class="modal fade" [class.show]="showDateEventsModal" [style.display]="showDateEventsModal ? 'block' : 'none'" tabindex="-1">\r
  <div class="modal-dialog modal-dialog-centered">\r
    <div class="modal-content">\r
      <div class="modal-header">\r
        <h5 class="modal-title">{{ 'CALENDAR_PAGE.EVENTS_ON' | translate }} {{ selectedDate | date:'fullDate':'':currentLocale }}</h5>\r
        <button type="button" class="btn-close" (click)="closeDateEventsModal()"></button>\r
      </div>\r
      <div class="modal-body">\r
        <div *ngFor="let holiday of selectedDateHolidays" class="mb-3 p-3 border rounded bg-danger bg-opacity-10">\r
          <h6 class="mb-2 text-danger">\u{1F389} {{ holiday.name }}</h6>\r
          <p class="mb-0"><strong>{{ 'CALENDAR_PAGE.HOLIDAY' | translate }}</strong></p>\r
        </div>\r
        <div *ngFor="let event of selectedDateEvents" class="mb-3 p-3 border rounded" (click)="selectedEvent = event; showDateEventsModal = false" style="cursor: pointer;">\r
          <h6 class="mb-2">{{ event.name }}</h6>\r
          <p class="mb-1"><strong>{{ 'CALENDAR_PAGE.TYPE' | translate }}</strong> {{ event.type }}</p>\r
          <p class="mb-0"><strong>{{ 'CALENDAR_PAGE.TIME' | translate }}</strong> {{ event.time | date:'shortTime':'':currentLocale }}</p>\r
        </div>\r
      </div>\r
      <div class="modal-footer">\r
        <button type="button" class="custom-btn-2 btn-cancel-2" (click)="closeDateEventsModal()">{{ 'CALENDAR_PAGE.CLOSE' | translate }}</button>\r
      </div>\r
    </div>\r
  </div>\r
</div>\r
<div class="modal-backdrop fade" [class.show]="showDateEventsModal" *ngIf="showDateEventsModal" (click)="closeDateEventsModal()"></div>\r
\r
<!-- No Events Modal -->\r
<div class="modal fade" [class.show]="showNoEventsModal" [style.display]="showNoEventsModal ? 'block' : 'none'" tabindex="-1">\r
  <div class="modal-dialog modal-dialog-centered">\r
    <div class="modal-content">\r
      <div class="modal-header">\r
        <h5 class="modal-title">{{ 'CALENDAR_PAGE.NO_EVENTS' | translate }}</h5>\r
        <button type="button" class="btn-close" (click)="closeNoEventsModal()"></button>\r
      </div>\r
      <div class="modal-body text-center">\r
        <i class="bi bi-calendar-x icon-3x mb-3 opacity-25"></i>\r
        <p>{{ 'CALENDAR_PAGE.NO_EVENT_ON_DATE' | translate }} {{ selectedDate | date:'fullDate':'':currentLocale }}</p>\r
      </div>\r
      <div class="modal-footer">\r
        <button type="button" class="custom-btn-2 btn-cancel-2" (click)="closeNoEventsModal()">{{ 'CALENDAR_PAGE.CLOSE' | translate }}</button>\r
      </div>\r
    </div>\r
  </div>\r
</div>\r
<div class="modal-backdrop fade" [class.show]="showNoEventsModal" *ngIf="showNoEventsModal" (click)="closeNoEventsModal()"></div>`, styles: ['/* src/app/features/calendar/calendar.component.scss */\nion-content.parent-calendar {\n  --background: #ffffff;\n  --padding-start: 0;\n  --padding-end: 0;\n  --padding-top: 0;\n  --padding-bottom: 0;\n  display: block !important;\n  position: relative !important;\n  min-height: calc(100vh - 95px) !important;\n}\nion-content.parent-calendar .inner-scroll {\n  display: block !important;\n}\n::ng-deep .header-info {\n  margin-bottom: 35px !important;\n}\n::ng-deep .profile-info-grid {\n  display: block !important;\n}\n::ng-deep .profile-info-grid .profile-info-card {\n  margin-bottom: 20px;\n}\n::ng-deep .profile-info-grid .profile-info-card .info-title {\n  font-size: 15px !important;\n  font-weight: 500 !important;\n  color: #202C4B !important;\n}\n::ng-deep .profile-info-grid .profile-info-card .info-desc {\n  font-size: 12px !important;\n  font-weight: 400 !important;\n}\n::ng-deep .fc-theme-standard {\n  box-shadow: none !important;\n  border-radius: 0 !important;\n}\n.main-information {\n  margin-top: 35px;\n}\n.main-information .fc-theme-standard {\n  padding: 15px !important;\n  border-radius: 16px !important;\n}\n.selected-day .card-header {\n  display: flex;\n  align-items: center;\n  border-bottom: 2px solid #f0f0f0;\n}\n.selected-day .card-header i {\n  font-size: 24px;\n  color: #7dd3c0;\n  margin-right: 12px;\n}\n::ng-deep .fc-header-toolbar .fc-button {\n  background:\n    linear-gradient(\n      135deg,\n      #a8c5ff 0%,\n      #7dd3c0 100%);\n  border: none;\n  color: white;\n}\n::ng-deep .fc-header-toolbar .fc-button:hover {\n  background: #7dd3c0;\n  color: white;\n}\n::ng-deep .fc-header-toolbar .fc-button:not(:disabled):active,\n::ng-deep .fc-header-toolbar .fc-button:active {\n  background: #7dd3c0;\n  color: white;\n}\n::ng-deep .fc-header-toolbar .fc-button:focus {\n  box-shadow: rgba(129, 210, 198, 0.5) 0px 0px 0px 0.2rem;\n}\n::ng-deep .fc {\n  font-size: 14px;\n}\n::ng-deep .fc-toolbar-title {\n  font-size: 18px !important;\n  font-weight: 500 !important;\n  color: #202C4B !important;\n}\n::ng-deep .fc-scrollgrid {\n  border: 1px solid #ddd;\n  width: 100%;\n}\n::ng-deep .fc-col-header-cell {\n  background: #f8f9fa;\n  padding: 10px;\n  text-align: center;\n  font-weight: 600;\n  border: 1px solid #ddd;\n}\n::ng-deep .fc-col-header-cell.fc-day {\n  background: #fff;\n  border: none;\n  text-align: center;\n  padding: 8px 0;\n}\n::ng-deep .fc-col-header-cell.fc-day a {\n  color: #202C4B !important;\n  font-size: 14px;\n  font-weight: 700;\n  text-decoration: none;\n}\n::ng-deep .fc-daygrid-day {\n  border: 1px solid #ddd;\n  min-height: 100px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n  background: #fff;\n}\n::ng-deep .fc-daygrid-day:hover {\n  background-color: #f8f9fa;\n}\n::ng-deep .fc-daygrid-day-frame {\n  padding: 5px;\n  min-height: 100px;\n}\n::ng-deep .fc-daygrid-day-top {\n  display: flex;\n  justify-content: flex-end;\n}\n::ng-deep .fc-daygrid-day-number {\n  padding: 4px 8px;\n  text-decoration: none;\n  color: #333;\n  font-weight: 500;\n}\n::ng-deep .fc-day-today {\n  background-color: transparent !important;\n}\n::ng-deep .fc-day-today .fc-daygrid-day-number {\n  background: #a8c5ff;\n  color: white;\n  border-radius: 50%;\n  width: 30px;\n  height: 30px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n::ng-deep .fc-day.holiday .fc-daygrid-day-number {\n  color: #dc3560;\n  font-weight: 700;\n}\n::ng-deep .fc-day.holiday .fc-daygrid-event.fc-event-end {\n  padding: 9px 6px;\n}\n::ng-deep .fc-day.holiday .fc-daygrid-event-dot {\n  border-color: #dc3560 !important;\n}\n::ng-deep .fc-day.holiday .fc-daygrid-event-harness {\n  background-color: #fbeaec;\n  border-radius: 5px;\n}\n::ng-deep .fc-day.holiday .fc-event-title {\n  color: #dc3560 !important;\n}\n::ng-deep .event-day .fc-daygrid-event.fc-event-end {\n  padding: 9px 6px;\n}\n::ng-deep .event-day .fc-daygrid-event-dot {\n  border-color: #7dd3c0 !important;\n}\n::ng-deep .event-day .fc-daygrid-event-harness {\n  border-color: #7dd3c0 !important;\n  background-color: #effcf9;\n  border-radius: 5px;\n}\n::ng-deep .event-day .fc-event-title {\n  color: #7dd3c0 !important;\n}\n::ng-deep .fc-day.event-day .fc-daygrid-day-number {\n  color: #7dd3c0 !important;\n  font-weight: 700;\n}\n::ng-deep .fc-daygrid-event-harness {\n  margin: 2px 0;\n}\n@media screen and (max-width: 768px) {\n  ::ng-deep .fc-daygrid-event-dot {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n  ::ng-deep .fc-event-title {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n  ::ng-deep .fc-daygrid-event {\n    display: none;\n  }\n}\n@media screen and (max-width: 768px) {\n  ::ng-deep .fc-daygrid-day-events {\n    display: none;\n  }\n}\n@media screen and (max-width: 767px) {\n  ::ng-deep .fc-daygrid-day:has(.fc-daygrid-event-harness) .fc-daygrid-day-number {\n    border-radius: 50%;\n    width: 30px;\n    height: 30px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n  ::ng-deep .fc-day-today .fc-daygrid-day-number {\n    background: #7dd3c0;\n  }\n}\n::ng-deep .fc-event {\n  display: block;\n  padding: 2px 4px;\n  border-radius: 3px;\n  font-size: 12px;\n  cursor: pointer;\n  border: none;\n  text-decoration: none;\n  color: rgb(7, 7, 7);\n}\n::ng-deep .fc-daygrid-dot-event {\n  padding-left: 4px;\n}\n::ng-deep .fc-event:hover {\n  opacity: 0.8;\n}\n::ng-deep .fc-event-main {\n  color: white;\n}\n::ng-deep .fc-event-title {\n  font-weight: 500;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n::ng-deep .fc-event-time {\n  font-size: 11px;\n  opacity: 0.9;\n}\n::ng-deep .fc-daygrid-day-events {\n  margin-top: 5px;\n}\n::ng-deep .fc-scroller {\n  overflow: visible !important;\n}\n::ng-deep table.fc-scrollgrid-sync-table {\n  width: 100%;\n  border-collapse: collapse;\n}\n.card-upcoming_calendar .card-header {\n  display: flex;\n  align-items: center;\n  border-bottom: 2px solid #f0f0f0;\n}\n.card-upcoming_calendar .card-header i {\n  font-size: 24px;\n  color: #7dd3c0;\n  margin-right: 12px;\n}\n.card-upcoming_calendar .name {\n  font-size: 15px;\n  font-weight: 500;\n  color: #7dd3c0;\n}\n.card-upcoming_calendar .time {\n  font-size: 12px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.card-upcoming_calendar .type {\n  font-size: 12px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.selected-event_day {\n  font-size: 15px;\n  font-weight: 500;\n  color: #202C4B;\n}\n.selected-event_time {\n  font-size: 13px;\n  font-weight: 400;\n  color: rgb(106, 114, 135);\n}\n.border-primary {\n  border-color: #7dd3c0 !important;\n  background-color: #effcf9;\n}\n::ng-deep .fc .fc-toolbar.fc-header-toolbar {\n  margin-bottom: 9px !important;\n}\n::ng-deep .fc-theme-standard {\n  background: white;\n  border-radius: 20px;\n  padding: 0px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n}\n@media screen and (max-width: 768px) {\n  ::ng-deep .fc-theme-standard td,\n  ::ng-deep .fc-theme-standard th {\n    border: none !important;\n  }\n  ::ng-deep .fc-scrollgrid {\n    border: none !important;\n  }\n  ::ng-deep .fc-daygrid-day:has(.fc-daygrid-event-harness) .fc-daygrid-day-number:before {\n    content: "";\n    width: 7px;\n    height: 7px;\n    background: var(--secondary-color);\n    bottom: -2px;\n    border-radius: 50px;\n    position: absolute;\n  }\n  ::ng-deep .fc-day.holiday .fc-daygrid-day-number:before {\n    background: #dc3560 !important;\n  }\n  ::ng-deep .fc-day.event-day .fc-daygrid-day-number {\n    color: var(--secondary-color) !important;\n  }\n  ::ng-deep .event-icon {\n    background: var(--secondary-color);\n    padding: 10px;\n    border-radius: 8px;\n  }\n  ::ng-deep .event-icon .day {\n    font-weight: bold;\n    color: white;\n  }\n  ::ng-deep .event-icon .month {\n    font-size: 14px;\n    font-weight: 400;\n    color: white;\n  }\n  ::ng-deep .clplace {\n    font-size: 13px;\n  }\n  ::ng-deep .date-type span {\n    font-size: 12px;\n  }\n  ::ng-deep .calender-mobile {\n    padding: 0px;\n  }\n  ::ng-deep .selectdate-mobile {\n    padding: 0px;\n  }\n}\n.event-item .event-card {\n  background: white;\n  border-radius: 14px;\n  padding: 16px;\n  display: flex;\n  align-items: center;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n  margin-bottom: 12px;\n  transition: transform 0.2s;\n}\n/*# sourceMappingURL=calendar.component.css.map */\n'] }]
  }], () => [{ type: AuthService }, { type: EventService }, { type: HolidayService }, { type: Router }, { type: TranslateService }, { type: PageTitleService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CalendarPageComponent, { className: "CalendarPageComponent", filePath: "src/app/features/calendar/calendar.component.ts", lineNumber: 37 });
})();
export {
  CalendarPageComponent
};
//# sourceMappingURL=chunk-5OFOSN4D.js.map
