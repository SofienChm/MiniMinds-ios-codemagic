...
} from "./chunk-CSXCHIWA.js";
import {
  transition
} from "./chunk-XZWAJE4W.js";
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-YFMAP5HH.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-MWBZKIBB.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-I7ATYACI.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./chunk-66H5K6IQ.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-WGDWP4CE.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-OMAGERL6.js").then((module) => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./chunk-NS2QAIS3.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GXFZZYC7.js.map
